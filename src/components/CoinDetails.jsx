import { Container, Box, RadioGroup, HStack, Radio, VStack, Text,Badge, Image, Stat, StatLabel, StatNumber, StatHelpText, StatArrow, Progress, Button } from '@chakra-ui/react'
...
{
  btns.map((i)=>(
    <Button isDisabled={days===i} key={i} onClick={()=>switchChartStats(i)} >{i}</Button>
  ))
}
       </HStack>
